...
const config = {
  ...
  tagline: 'Demystifying AI Systems that Interact with the Physical World',
  ...
  url: 'https://website-one-omega-91.vercel.app',
  ...
  organizationName: 'iam-jatoi', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/physical-ai/physical-ai-book/edit/main/website/',
        },
        blog: {
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/physical-ai-book/chapter-1/',
              },
            ],
          },
          {
